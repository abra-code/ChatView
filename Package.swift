...
let package = Package(
    ...
    dependencies: [
        ...
        // 0.2.4 adds remoteImages, which ChatConfiguration.remoteImages hands to every RichText it renders.
        .package(url: "https://github.com/abra-code/RichText", from: "0.2.4"),          // renders message Markdown
